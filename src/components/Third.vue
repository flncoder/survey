<template>
  <div class="commitment">
    <div v-if="step === 'one'">
      ...
      <img class="taboo_eg" src="../../static/images/doc.png" />
...
export default {
  ...
  data () {
    return {
      ...
      setPrice: '',
      istrue: '',
      computerNum: localStorage.getItem('dotCountingPrice') || 5,
      pricetimer: null
    }
  },
  mounted () {
  ...
  methods: {
    saveForm () {
      var data = {
        ...
        updating: {
          participantMaxPage: 8,
          participantCurrentAppName: 'Dot Counting',
          ParticipantCurrentPageName: 'Dot Counting-introduction',
          finishedOrNo: false
        },
        taboo: {},
        dotCounting: {
    ...
    getPrice () {
      localStorage.setItem('dotCountingUserPrice', this.setPrice)
      ...
      this.saveForm()
      this.$router.push({name: 'QuizResults', query: {step: 'Third', nextstep: 'thirdplay', nextGame: 'fourth', result: this.istrue, setPrice: this.setPrice, computerNum: this.computerNum}})
    }
  }
}
</script>
