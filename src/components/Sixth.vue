<template>
  <div class="commitment">
    <div v-if="step === 'one'">
      ...
      <img class="pdf_eg" src="../../static/images/pdf_eg.jpg" />
...
export default {
  ...
  data () {
    return {
      ...
      setPrice: '',
      istrue: '',
      computerNum: localStorage.getItem('transcribingPrice') || 5,
      pricetimer: null
    }
  },
  mounted () {
  ...
  methods: {
    saveForm () {
      var data = {
        ...
        updating: {
          participantMaxPage: 18,
          participantCurrentAppName: 'Transcription task',
          ParticipantCurrentPageName: 'Transcription task-introduction',
          finishedOrNo: false
        },
        taboo: {},
        dotCounting: {},
    ...
    getPrice () {
      localStorage.setItem('transcribingUserPrice', this.setPrice)
      ...
      this.saveForm()
      this.$router.push({name: 'QuizResults', query: {step: 'Sixth', nextstep: 'sixthplay', nextGame: 'seventh', result: this.istrue, setPrice: this.setPrice, computerNum: this.computerNum}})
    }
  }
}
</script>
